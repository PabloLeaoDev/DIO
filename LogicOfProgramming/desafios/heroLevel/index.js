...
rl.question('\nDigite o nome do herói: ', (name) => {
  ...
  rl.question('Digite quanto de experiência o herói possui: ', (xp) => {
    ...
    switch (true) {
      case convertXP <= 1000:
        console.log(`\nO Herói de nome ${hero[0]} está no nível Ferro.`);
        break;
      case convertXP > 1000 && convertXP <= 5000 :
        console.log(`\nO Herói de nome ${hero[0]} está no nível Bronze.`);
        break;
      case convertXP > 5000 && convertXP <= 6000:
        console.log(`\nO Herói de nome ${hero[0]} está no nível Prata.`);
        break;
      case convertXP > 6000 && convertXP <= 7000:
        console.log(`\nO Herói de nome ${hero[0]} está no nível Ouro.`);
        break;
      case convertXP > 7000 && convertXP <= 8000:
        console.log(`\nO Herói de nome ${hero[0]} está no nível Platina.`);
        break;
      case convertXP > 8000 && convertXP <= 9000:
        console.log(`\nO Herói de nome ${hero[0]} está no nível Ascendente.`);
        break;
